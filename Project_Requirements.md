...
|---|---|---|---|---|---|
| 1 | Create Account | All Users | User launches the application. User provides email address for the account and creates a password. The user sets their screen name and possibly a profile picture. The user will save their changes and notified that edits can be made later on. |  |  |
